package com.premierdarkcoffee.sales.cronos.feature.authentication.presentation.view

//
//  AuthenticationView.kt
//  Cronos
//
//  Created by José Ruiz on 17/1/25.
//
...
fun AuthenticationView(onSubmitApiKeyButtonClicked: () -> Unit) {
    ...
    Box(modifier = Modifier
        ...
        Column(horizontalAlignment = Alignment.CenterHorizontally, verticalArrangement = Arrangement.Center) {
            // Title
            Text(text = stringResource(id = R.string.authenticate_title),
                 style = MaterialTheme.typography.headlineLarge,
                 color = MaterialTheme.colorScheme.primary,
                 modifier = Modifier.padding(bottom = 8.dp))

            Text(text = stringResource(id = R.string.authenticate_description),
            ...
            if (!isValidKey && inputText.text.isNotEmpty()) {
                Text(text = stringResource(id = R.string.invalid_api_key_format),
