        ...
        LazyColumn(modifier = modifier
            ...
            item {
                SettingsSectionView(title = "3. Authentication", content = """
                    ...
                    """.trimIndent())
                BulletPointList(bulletPoints = listOf("Encrypted: API keys are securely encrypted and stored locally on the administrator’s device.",
            ...
            item {
                SettingsSectionView(title = "10. Contact Us", content = """
