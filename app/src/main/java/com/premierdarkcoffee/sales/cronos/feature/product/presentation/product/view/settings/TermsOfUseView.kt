...
fun TermsOfUseView(modifier: Modifier = Modifier) {
    Scaffold(topBar = {
        ...
        LazyColumn(modifier = modifier
            ...
            item {
                SettingsSectionView(title = "1. Introduction",
            ...
            item {
                SettingsSectionView(title = "2. User Eligibility",
            ...
            item {
                SettingsSectionView(title = "3. Authentication",
            ...
            item {
                SettingsSectionView(title = "4. Administrative Management and Updates",
            ...
            item {
                SettingsSectionView(title = "5. Data Security",
            ...
            item {
                SettingsSectionView(title = "6. Prohibited Activities",
                                    content = "Administrators of Cronos are prohibited from engaging in the following activities:")
                BulletPointList(bulletPoints = listOf("Attempting to bypass security measures or gain unauthorized access to data.",
            ...
            item {
                SettingsSectionView(title = "7. Termination",
            ...
            item {
                SettingsSectionView(title = "8. Limitation of Liability",
            ...
            item {
                SettingsSectionView(title = "9. Updates to Terms",
            ...
            // Contact Information
            item {
                Text(text = "If you have any questions or need assistance, please contact us at terms@premierdarkcoffee.com.",
                     color = Color.Blue,
            ...
            // Footer
            item {
                Text(text = "© 2024 Cronos, Premier Dark Coffee. All Rights Reserved.",
